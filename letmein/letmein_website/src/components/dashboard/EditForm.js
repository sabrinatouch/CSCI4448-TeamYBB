...
export default class FormDialog extends React.Component {
    ...
    // Instantiate values that are passed in
    // Sets values in the same row as the Edit button
    // To display when form appears
  constructor(props) { 
    super(props)
      this.state = {
        id: props.row.id,
  ...
  onSubmit(e) {
    ...
    this.handleClose()
    console.log("onSubmit-Edit clicked")
  }

  // Renders the Edit button and popup form when button is clicked
  render () {
    return (
      <div>
